...
library(tidyverse)
library(purrr)
b2b <- read_excel("working directory for file")
full_season <- read_excel("working directory for file")
...
diff_data_2023_min = data.frame(Name = fs_2023$Player, Difference = average_minutes_2023$Difference)
